...
export const validationMessages: ValidationMessage[] = [
  ...
  {error: 'required', formControlName: ['customerName'], message: 'Please enter a valid customer name'},
  {error: 'required', formControlName: ['customerEmail'], message: 'Please enter a customer email'},
  {error: 'email', formControlName: ['customerEmail'], message: 'Please enter a valid email'},
  {error: 'required', formControlName: ['customerPhone'], message: 'Please enter a customer phone number'},
  {error: 'phone-invalid', formControlName: ['customerPhone'], message: 'Please enter a valid phone number'},
  {error: 'required', formControlName: ['unitName'], message: 'Please enter a unit name'},
